...
function FormDataProvider({ children }) {
  ...
  // const nonEmptyValues = Object.keys(defaultValues).filter(
  //   (key) => defaultValues[key] !== ''
  // );
  // const filteredValues = nonEmptyValues.reduce((obj, key) => {
  //   if (key === 'had_antibody_test') {
  //     if (defaultValues[key] === 'კი') {
  //       obj[key] = true;
  //     }
  //     if (defaultValues[key] === 'არა') {
  //       obj[key] = false;
  //     }
  //   } else {
